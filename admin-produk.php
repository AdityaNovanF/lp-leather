...
<div class="admin-sidebar">
  ...
  <a href="admin-produk.php" class="nav-link active">Produk</a>
...
<div class="admin-main">
  <h2 class="mb-4" style="font-weight:700; letter-spacing:1px;">Manajemen Produk</h2>
  <div class="d-flex justify-content-between align-items-center mb-3">
    <form class="d-flex" style="gap:0.5rem;">
      <input type="text" class="form-control" placeholder="Cari produk..." style="max-width:220px;">
      <button class="btn btn-dark">Cari</button>
    </form>
    <a href="#" class="btn btn-success"><i class="fas fa-plus me-1"></i>Tambah Produk</a>
  </div>
  <div class="card p-3">
    <table class="table table-bordered table-hover align-middle mb-0">
      ...
      <tbody>
        <tr><td>1</td><td>Venice Shoulder Bag</td><td>Women Bags</td><td>Rp 350.000</td><td>12</td><td>
          <a href="#" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
          <a href="#" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
        </td></tr>
        <tr><td>2</td><td>Roman Bag</td><td>Men Bags</td><td>Rp 225.000</td><td>7</td><td>
          <a href="#" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
          <a href="#" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
        </td></tr>
      </tbody>
