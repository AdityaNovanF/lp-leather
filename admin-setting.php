...
<div class="admin-sidebar">
  ...
  <a href="admin-setting.php" class="nav-link active">Setting</a>
</div>
<div class="admin-main" style="margin-left:240px; padding:2.5rem 2rem 2rem 2rem; background:#f7f7f7; min-height:100vh;">
  <h2 class="mb-4" style="font-weight:700; letter-spacing:1px;">Pengaturan Website</h2>
  <div class="card p-4" style="max-width:600px;">
    <form>
      <div class="mb-3">
        <label class="form-label">Nama Toko</label>
        <input type="text" class="form-control" value="Garut Kulit">
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" rows="2">Jl. Raya Garut No. 123</textarea>
      </div>
      <div class="mb-3">
        <label class="form-label">Logo Toko</label>
        <input type="file" class="form-control">
      </div>
      <button class="btn btn-dark">Simpan Pengaturan</button>
    </form>
  </div>
</div>
<?php
