...
<div class="admin-sidebar">
  ...
  <a href="admin-kategori.php" class="nav-link active">Kategori</a>
...
<div class="admin-main" style="margin-left:240px; padding:2.5rem 2rem 2rem 2rem; background:#f7f7f7; min-height:100vh;">
  <h2 class="mb-4" style="font-weight:700; letter-spacing:1px;">Manajemen Kategori</h2>
  <div class="d-flex justify-content-between align-items-center mb-3">
    <form class="d-flex" style="gap:0.5rem;">
      <input type="text" class="form-control" placeholder="Tambah kategori..." style="max-width:220px;">
  ...
  <div class="card p-3">
    <table class="table table-bordered table-hover align-middle mb-0">
      <thead class="table-light">
        <tr><th>#</th><th>Nama Kategori</th><th>Aksi</th></tr>
      </thead>
      <tbody>
        <tr><td>1</td><td>Women Bags</td><td>
          <a href="#" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
          <a href="#" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
        </td></tr>
        <tr><td>2</td><td>Men Wallets</td><td>
          <a href="#" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
          <a href="#" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
        </td></tr>
      </tbody>
