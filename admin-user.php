...
<div class="admin-sidebar">
  ...
  <a href="admin-user.php" class="nav-link active">User</a>
...
<div class="admin-main" style="margin-left:240px; padding:2.5rem 2rem 2rem 2rem; background:#f7f7f7; min-height:100vh;">
  <h2 class="mb-4" style="font-weight:700; letter-spacing:1px;">Manajemen User</h2>
  <div class="d-flex justify-content-between align-items-center mb-3">
    <form class="d-flex" style="gap:0.5rem;">
      <input type="text" class="form-control" placeholder="Cari user..." style="max-width:220px;">
      <button class="btn btn-dark">Cari</button>
    </form>
    <a href="#" class="btn btn-success"><i class="fas fa-plus me-1"></i>Tambah User</a>
  </div>
  <div class="card p-3">
    <table class="table table-bordered table-hover align-middle mb-0">
      ...
      <tbody>
        <tr><td>1</td><td>Admin</td><td>admin@email.com</td><td>Admin</td><td>
          <a href="#" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
          <a href="#" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
        </td></tr>
        <tr><td>2</td><td>Budi</td><td>budi@email.com</td><td>User</td><td>
          <a href="#" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
          <a href="#" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
        </td></tr>
      </tbody>
