...
<section class="container my-5">
  <h2 class="mb-4 text-center" style="font-weight:700; letter-spacing:1px;">Dompet Kulit Wanita Asli</h2>
  <div class="produk-masonry">
    <?php 
      ...
      for($i=1;$i<=12;$i++): 
        ...
        $nama = "Dompet Wanita Asli $i";
        $harga = number_format(250000 + $i*5000,0,',','.');
    ?>
