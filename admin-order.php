...
<div class="admin-sidebar">
  ...
  <a href="admin-order.php" class="nav-link active">Order</a>
...
<div class="admin-main" style="margin-left:240px; padding:2.5rem 2rem 2rem 2rem; background:#f7f7f7; min-height:100vh;">
  <h2 class="mb-4" style="font-weight:700; letter-spacing:1px;">Manajemen Order</h2>
  <div class="d-flex justify-content-between align-items-center mb-3">
    <form class="d-flex" style="gap:0.5rem;">
      <input type="text" class="form-control" placeholder="Cari order..." style="max-width:220px;">
  ...
  <div class="card p-3">
    <table class="table table-bordered table-hover align-middle mb-0">
      <thead class="table-light">
        <tr><th>#</th><th>Nama</th><th>Tanggal</th><th>Status</th><th>Total</th><th>Aksi</th></tr>
      </thead>
      <tbody>
        <tr><td>1</td><td>Andi</td><td>2024-06-01</td><td><span class="badge bg-success">Selesai</span></td><td>Rp 1.200.000</td><td>
          <a href="#" class="btn btn-sm btn-warning">Proses</a>
          <a href="#" class="btn btn-sm btn-danger">Batal</a>
        </td></tr>
        <tr><td>2</td><td>Budi</td><td>2024-06-01</td><td><span class="badge bg-warning text-dark">Proses</span></td><td>Rp 850.000</td><td>
