...
<section class="container my-5">
  <h2 class="mb-4 text-center" style="font-weight:700; letter-spacing:1px;">Kerajinan Jaket Kulit Original</h2>
  <div class="produk-masonry">
    <?php 
      ...
      for($i=1;$i<=12;$i++): 
        ...
        $nama = "Kerajinan Jaket $i";
        $harga = number_format(1800000 + $i*20000,0,',','.');
    ?>
